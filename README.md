...
*ApiApi* | [**api_documents_create**](docs/ApiApi.md#api_documents_create) | **POST** /api/documents/ | 
*ApiApi* | [**api_documents_delete**](docs/ApiApi.md#api_documents_delete) | **DELETE** /api/documents/{id}/ | 
*ApiApi* | [**api_documents_image_list**](docs/ApiApi.md#api_documents_image_list) | **GET** /api/documents/{id}/image/ | 
*ApiApi* | [**api_documents_list**](docs/ApiApi.md#api_documents_list) | **GET** /api/documents/ | 
*ApiApi* | [**api_documents_partial_update**](docs/ApiApi.md#api_documents_partial_update) | **PATCH** /api/documents/{id}/ | 
*ApiApi* | [**api_documents_read**](docs/ApiApi.md#api_documents_read) | **GET** /api/documents/{id}/ | 
*ApiApi* | [**api_documents_update**](docs/ApiApi.md#api_documents_update) | **PUT** /api/documents/{id}/ | 
...
*ApiApi* | [**api_userstory_create**](docs/ApiApi.md#api_userstory_create) | **POST** /api/userstory/ | 
*ApiApi* | [**api_userstory_delete**](docs/ApiApi.md#api_userstory_delete) | **DELETE** /api/userstory/{userstory_id}/ | 
*ApiApi* | [**api_userstory_list**](docs/ApiApi.md#api_userstory_list) | **GET** /api/userstory/ | 
*ApiApi* | [**api_userstory_partial_update**](docs/ApiApi.md#api_userstory_partial_update) | **PATCH** /api/userstory/{userstory_id}/ | 
*ApiApi* | [**api_userstory_read**](docs/ApiApi.md#api_userstory_read) | **GET** /api/userstory/{userstory_id}/ | 
*ApiApi* | [**api_userstory_update**](docs/ApiApi.md#api_userstory_update) | **PUT** /api/userstory/{userstory_id}/ | 
...
## Documentation For Models
 ...
 - [ApiChatHistory200Response](docs/ApiChatHistory200Response.md)
 - [ApiChatUploadFile200Response](docs/ApiChatUploadFile200Response.md)
 - [ApiDocumentsCreateRequest](docs/ApiDocumentsCreateRequest.md)
 - [ApiDocumentsImageList200Response](docs/ApiDocumentsImageList200Response.md)
