...
class TestApiDocumentsImageList200Response(unittest.TestCase):
    """ApiDocumentsImageList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiDocumentsImageList200Response:
        """Test ApiDocumentsImageList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiDocumentsImageList200Response`
        """
        model = ApiDocumentsImageList200Response()
        if include_optional:
            return ApiDocumentsImageList200Response(
                count = 56,
                next = '',
                previous = '',
                results = [
                    pp_sdk.models.document.Document(
                        id = '', 
                        type = 'PRD', 
                        title = '0', 
                        body = '0', 
    ...
    def testApiDocumentsImageList200Response(self):
        """Test ApiDocumentsImageList200Response"""
