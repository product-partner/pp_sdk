...
class ChatUploadApi:
    ...
    def chat_upload_list(
        ...
        _param = self._chat_upload_list_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def chat_upload_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def chat_upload_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _chat_upload_list_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
