...
class ChatApi:
    ...
    def chat_threads_read(
        ...
        _param = self._chat_threads_read_serialize(
            thread_id=thread_id,
            x_user_id=x_user_id,
            x_caller_id=x_caller_id,
            x_caller_thread_id=x_caller_thread_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ChatThreadsRead200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def chat_threads_read_with_http_info(
        self,
        thread_id: StrictStr,
        x_user_id: Annotated[Optional[StrictStr], Field(description="User ID (required when using API key)")] = None,
        x_caller_id: Annotated[Optional[StrictStr], Field(description="Optional ID of the application calling the ID, used in conjunction with the caller_thread_id")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ChatThreadsRead200Response]:
        """chat_threads_read
    ...
    @validate_call
    def chat_threads_read_without_preload_content(
        self,
        thread_id: StrictStr,
        x_user_id: Annotated[Optional[StrictStr], Field(description="User ID (required when using API key)")] = None,
        x_caller_id: Annotated[Optional[StrictStr], Field(description="Optional ID of the application calling the ID, used in conjunction with the caller_thread_id")] = None,
    ...
    def _chat_threads_read_serialize(
        self,
        thread_id,
        x_user_id,
        x_caller_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/chat/threads/{thread_id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
