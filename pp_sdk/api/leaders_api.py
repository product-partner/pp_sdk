...
class LeadersApi:
    ...
    def leaders_list(
        ...
        _param = self._leaders_list_serialize(
    ...
    @validate_call
    def leaders_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def leaders_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
