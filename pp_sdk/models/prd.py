...
class PRD(BaseModel):
    ...
    programs: Optional[List[ProgramBase]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "programs", "description", "body", "created_date", "modified_date", "due_date", "status", "tags", "owner_user", "stakeholder_users", "created_by", "organization"]
