...
class Example(BaseModel):
    ...
    example_text: Annotated[str, Field(min_length=1, strict=True)]
    is_public: Optional[StrictBool] = None
    organization: Optional[StrictStr] = None
    created_by: Optional[UserField] = None
    created_date: Optional[datetime] = None
    modified_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "example_text", "is_public", "organization", "created_by", "created_date", "modified_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "example_text": obj.get("example_text"),
