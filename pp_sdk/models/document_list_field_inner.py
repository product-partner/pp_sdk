...
class DocumentListFieldInner(BaseModel):
    """
    DocumentListFieldInner
    """ # noqa: E501
    id: StrictStr = Field(description="Document ID")
    title: Optional[StrictStr] = Field(default=None, description="Optional, only used in response")
    type: Optional[StrictStr] = Field(default=None, description="Optional, only used in response")
