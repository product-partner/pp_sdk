...
class ApiUserSearchList200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiUserSearchList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiUserSearchList200Response:
        """Create an instance of ApiUserSearchList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiUserSearchList200Response.parse_obj(obj)

        _obj = ApiUserSearchList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
