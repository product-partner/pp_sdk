...
class SectionContext(BaseModel):
    ...
    query_string: Annotated[str, Field(min_length=1, strict=True, max_length=1024)]
    section: Optional[StrictStr] = None
    organization: Optional[StrictStr] = None
    created_by: Optional[UserField] = None
    created_date: Optional[datetime] = None
    modified_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "prompt", "query_string", "section", "organization", "created_by", "created_date", "modified_date"]
