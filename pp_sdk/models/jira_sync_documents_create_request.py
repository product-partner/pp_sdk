...
class JiraSyncDocumentsCreateRequest(BaseModel):
    """
    JiraSyncDocumentsCreateRequest
    """ # noqa: E501
    sync_enabled: StrictBool = Field(description="Whether to enable or disable Jira sync")
    __properties: ClassVar[List[str]] = ["sync_enabled"]
