...
class PRDDetail(BaseModel):
    ...
    programs: conlist(ProgramBase) = Field(...)
    ...
    __properties = ["id", "title", "programs", "description", "body", "created_date", "modified_date", "due_date", "status", "tags", "owner_user", "stakeholder_users", "created_by", "organization", "goals"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PRDDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PRDDetail:
        """Create an instance of PRDDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PRDDetail.parse_obj(obj)

        _obj = PRDDetail.parse_obj({
            "id": obj.get("id"),
            "title": obj.get("title"),
